...
const orders = [
  {
    ...
    status: "Delivered",
    items: [
      { name: "UK wig (Dozen)", quantity: 2, price: 5.99 },
      { name: "Ebony wig pink (18-pack)", quantity: 1, price: 8.99 },
    ]
  },
  {
    id: "ORD002",
    ...
    status: "Processing",
    items: [
      { name: "India Wig (24-pack)", quantity: 1, price: 12.99 },
      { name: "Human Hair (6-pack)", quantity: 2, price: 7.99 },
    ]
  },
  {
    id: "ORD003",
    ...
    status: "Shipped",
    items: [
      { name: "Brazillian wig (Dozen)", quantity: 3, price: 5.99 },
      { name: "Jamaican wig (Pack of 10)", quantity: 1, price: 3.99 },
    ]
  },
]
...
export default function HairOrder() {
  ...
  return (
    <div className="container mx-auto py-10">
      {/* <h1 className="text-lg font-bold mb-6">Hair Order Management</h1> */}
      <Tabs defaultValue='Hair' className="space-y-4">
              ...
              <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
                <Card className="w-full lg:w-2/3">
                  <CardHeader>
                    <CardTitle>Hair Order</CardTitle>
